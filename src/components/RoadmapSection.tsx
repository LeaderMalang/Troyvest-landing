    ...
    <section id="roadmap" className="py-28 relative overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-6 relative">
        ...
        <div className="relative">
          {/* Center line */}
          <div className="hidden lg:block absolute top-0 bottom-0 left-1/2 w-[2px] bg-gradient-to-b from-yellow-500/60 via-yellow-300/40 to-transparent"></div>
          ...
          <div className="space-y-16">
            {phases.map((phase, index) => (
              ...
              >
                ...
                >
                  <Card className="p-8 bg-white/5 backdrop-blur-xl border border-yellow-600/30 shadow-[0_0_40px_-5px_rgba(255,215,0,.2)] hover:shadow-[0_0_60px_-5px_rgba(255,215,0,.4)] transition-all duration-300">
                    <div className="flex items-center gap-4 mb-4">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-yellow-500 to-yellow-300 flex items-center justify-center shadow-[0_0_25px_rgba(255,215,0,.7)]">
                ...
                {/* Gold Dot */}
                <div className="hidden lg:flex w-8 h-8 rounded-full bg-yellow-400 shadow-[0_0_25px_rgba(255,215,0,0.8)]"></div>
...
//       items: [
//         "Launch Lending/Borrowing Protocol",
//         "Launch v1 of Decentralized Asset Insurance",
//         "Community Growth Initiatives",
//       ],
//     },
//     {
...
//       icon: Globe,
//       items: [
//         "First Midas DAO vote on Treasury release",
//         "Launch of Real-World Insurance",
//         "Begin Troyvest DEX development",
//       ],
//     },
//   ];
...
//             Our Path to <span className="gradient-text-primary">Full Decentralization</span>
//           </h2>
//         </div>

//         <div className="relative">
//           <div className="absolute top-0 bottom-0 left-1/2 w-1 bg-gradient-primary hidden lg:block"></div>
...
//                   <Card className="glass-card p-6 inline-block max-w-lg">
//                     <div className="flex items-center gap-4 mb-4">
...
//                 <div className="hidden lg:block w-8 h-8 rounded-full bg-primary glow-primary z-10 flex-shrink-0"></div>
