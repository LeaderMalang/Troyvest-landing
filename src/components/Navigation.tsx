  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black/50 backdrop-blur-xl border-b border-white/10 shadow-lg">
      <div className="container mx-auto flex items-center justify-between py-4 px-4 md:px-8">
        {/* Logo */}
        <div className="text-3xl font-black tracking-tight bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent">
          Troyvest
        </div>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Button className="font-semibold flex items-center gap-2 bg-gradient-to-r from-yellow-400 to-orange-500 text-black hover:shadow-[0_0_15px_rgba(255,199,0,0.7)]">
            <Wallet size={18} />
            Connect Wallet
          </Button>
        </div>
      ...
      {open && (
        <div className="md:hidden bg-black/90 backdrop-blur-xl border-t border-white/10 px-6 py-4 animate-in slide-in-from-top">
          ...
          <Button className="w-full mt-3 bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-semibold flex items-center gap-2">
            <Wallet size={18} />
            Connect Wallet
          </Button>
        </div>
