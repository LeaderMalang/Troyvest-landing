...
//             <h3 className="text-3xl font-bold">The "Trust Me" Problem</h3>

//             <p className="text-muted-foreground leading-relaxed">
//               In today's crypto market, investors have to blindly trust that teams won't abandon
//               projects or mismanage the treasury. When teams hold 40% of the supply, "trust" is
//               the only thing securing your investment.
//             </p>
//           </Card>

//           <Card className="glass-card p-8 space-y-6 glow-primary">
...
//             <p className="text-muted-foreground leading-relaxed">
//               We've replaced "trust" with on-chain proof. Our 40% team treasury is locked for
//               5 years. It can only be accessed, bit by bit, if{" "}
//               <span className="text-midas-gold-light font-semibold">Midas (MDS)</span> token
//               holders vote YES. If we don't perform, the community cuts our funding. That's
//               real accountability.
//             </p>
//           </Card>
//         </div>
